...
void SX1276FskInit( void )
{
    ...
    SX1276->RegLna = RF_LNA_GAIN_G1;
	  if(FskSettings.RFFrequency>700000000){
			SX1276->RegLna = RF_LNA_GAIN_G1 | RF_LNA_BOOST_HF_ON;
			SX1276Write( 0x70, 3<<6 );//PLL = 300khz
    ...
    else
    {
		...
		//Set preamble bytes number and tolerance of error.
    ...
    SX1276->RegRssiThresh = 0xFF;
		...
		//Set sync words length and value
    ...
    SX1276->RegPacketConfig1 = RF_PACKETCONFIG1_PACKETFORMAT_VARIABLE | RF_PACKETCONFIG1_DCFREE_WHITENING  |
    ...
    SX1276->RegPayloadLength = FskSettings.PayloadLength; //Set as 0xFF to enable variable length
