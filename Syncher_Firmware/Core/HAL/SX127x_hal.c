 ...
 */
#define DIO0_IOPORT                                 DIO0_GPIO_Port
#define DIO0_PIN                                    DIO0_Pin

#define DIO1_IOPORT                                 DIO1_GPIO_Port
#define DIO1_PIN                                    DIO1_Pin

#define DIO3_IOPORT                                 DIO3_GPIO_Port
#define DIO3_PIN                                    DIO3_Pin

#define DIO4_IOPORT                                 DIO4_GPIO_Port
#define DIO4_PIN                                    DIO4_Pin
...
{
    GPIO_WriteBit( NSS_IOPORT, NSS_PIN, (GPIO_PinState) status );
}

//复位引脚控制status=0拉低，其他拉高
void SX127X_ResetPinControl( uint8_t status )
{
	GPIO_WriteBit( RESET_IOPORT, RESET_PIN,(GPIO_PinState) status );
}
